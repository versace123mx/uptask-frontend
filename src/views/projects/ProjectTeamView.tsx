...
const ProjectTeamView = () => {
    ...
    if(data)return (
        <>
            ...
            {/**
             * Este modal AddMemberModal carga desde que esta en la pagina de team, pero como ya trae la logica interna, para abrirce o cerrarce, por eso es qu
             * no hay nececidad de colocarlo aqui un if, por que su logica interna que esta antes del return ya sabe si esta abierto o cerado
             */}
            <AddMemberModal />
        </>
    )
