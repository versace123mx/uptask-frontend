...
export default function DeleteProjectModal() {
    ...
    //Esta es una primer mutacion pero manejada de forma distinta ya que aqui se ejecutaran dos mutaciones, primera la de comprobar el password y luego la de eliminar el proyecto
    ...
    //Agregando la mutacion de @tanstack/react-query, que es la que se conecta con la funcion que hace la peticion via axios
    //Esta es la segunda mutacion se que ejecutara
